...
const LIBRARY: Collection[] = [
  ...
  {
    id: "proclamations",
    label: "Proclamations & Epistles",
    works: [
      { id: "proclamations", label: "LDS Proclamations", meta: "Family · Living Christ · Restoration", profile: "proclamations", type: "scripture" },
    ],
  },
  {
  ...
  },
  {
    ...
    works: [
      { id: "cfm-2026",  label: "Come, Follow Me 2026", meta: "Old Testament",              profile: "cfm-2026",  type: "curriculum" },
